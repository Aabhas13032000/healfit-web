...
//Upload Single Slider Images
router.post('/uploadSingleSliderImage/:id/:category/:value',upload.array('book_images'),commonMiddlewares.uploadSingleSliderImage);
//Delete photo
...
//Save category edit image
router.post('/saveCategoryEditImages/:id',upload.array('book_images'),commonMiddlewares.saveCategoryEditImages);
//Save PDF
